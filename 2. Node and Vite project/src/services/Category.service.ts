...
export default class CategoryService {
  ...
  list = async (): Promise<Result<Category[]>> => await CategoryApi.list()

  create = async (category: Category): Promise<Result<Category>> => await CategoryApi.create(category)

  delete = async (id: number) => await CategoryApi.delete(id)
}
