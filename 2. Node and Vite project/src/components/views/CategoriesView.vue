...
import CategoriesTable from '@/components/Category/Category_Table.vue'
import CategoryNew from '@/components/Category/Category_New.vue'
import ErrorMessage from '@/components/ErrorMessage.vue'
import Button from '@/components/controls/VButton.vue'
import SingleCategory from '@/components/Category/Category_Single.vue'
...
const remove = (id: number) => {
  categoriesStore.removeCategory(id).then((result) => {
    if (result.isSuccess) console.info('')
